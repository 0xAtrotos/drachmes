...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 9308;
...
const char     CRYPTONOTE_NAME[]                             = "drachmes";
...
const char* const SEED_NODES[] = { "i1.drachmes.net:18870", "i2.drachmes.net:18870" };
